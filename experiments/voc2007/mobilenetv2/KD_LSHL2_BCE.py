...
parameters = {
    ...
    'arch': 'mobilenet_v2',
    'force_2FC': True,
    #'pretrained': 'pretrained/mnv2_feat_fc@r101_voc_l2_1.ckpt',
    #'pretrained': 'pretrained/mnv2_feat_fc@r101_voc_lsh_1.ckpt',
    'pretrained': 'pretrained/mnv2_feat_fc@r101_voc_lshl2_1.ckpt',
